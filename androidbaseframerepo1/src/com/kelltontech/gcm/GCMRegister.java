...
public abstract class GCMRegister
{
    ...
    protected boolean checkPlayServices()
    {
        ...
        if (resultCode != ConnectionResult.SUCCESS)
        {
            ...
            {
                Log.i(LOG_TAG, "Google Play Service Error:" + GooglePlayServicesUtil.isUserRecoverableError(resultCode) + " .");
            ...
            public void run()
            {
                ...
                for (int i = 1; i <= MAX_ATTEMPTS; i++)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Log.e(LOG_TAG, "GCM  Registration token is null/blank on attempt " + i);
                            if (i == MAX_ATTEMPTS)
                            {
                                break;
                            }
                    ...
                    catch (IOException ex)
                    {
                        ...
                        Log.e(LOG_TAG, "GCM Registration Error :" + ex.getMessage());
                        // If there is an error, don't just keep trying to register.
                        // exponential back-off.
                        Log.e(LOG_TAG, "Failed to register with GCM on attempt " + i + ":" + ex);
                        if (i == MAX_ATTEMPTS)
                        {
                            break;
                        }
